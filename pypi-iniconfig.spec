...
%prep
%setup -q -n iniconfig-2.0.0
cd %{_builddir}/iniconfig-2.0.0
pushd ..
cp -a iniconfig-2.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673281671
...
cp %{_builddir}/iniconfig-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/pypi-iniconfig/cf3eaf29116a37a7d9ba773e776104c067c8e5fc || :
