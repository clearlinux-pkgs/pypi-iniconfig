...
Source0  : https://files.pythonhosted.org/packages/f2/97/ebf4da567aa6827c909642694d71c9fcf53e5b504f2d96afea02718862f3/iniconfig-2.1.0.tar.gz
...
%prep
%setup -q -n iniconfig-2.1.0
cd %{_builddir}/iniconfig-2.1.0
pushd ..
cp -a iniconfig-2.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742430338
...
cp %{_builddir}/iniconfig-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/pypi-iniconfig/dbe255817a806ecf727cf31b906af80882b84ea1 || :
...
/usr/share/package-licenses/pypi-iniconfig/dbe255817a806ecf727cf31b906af80882b84ea1
